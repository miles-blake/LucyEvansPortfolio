    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-px bg-border">
      {photos.map((photo, i) => (
        <Link
          ...
          className="group relative bg-cream overflow-hidden focus-visible:outline-2 focus-visible:outline-ring focus-visible:outline-offset-0"
        >
          {/* Image */}
          ...
          <div className="px-2 py-1.5 flex items-start justify-between gap-2 bg-cream border-t border-border">
            ...
            <span className="font-meta text-muted-foreground text-[10px] flex-shrink-0">
              {frameLabel(i)}
            </span>
          </div>
        </Link>
